...
const MIGRATION_TYPES = [
  ...
  {
    id: 'kafka-to-kinesis',
    label: 'Kafka to AWS Kinesis',
    description: 'Migrate Kafka streams to Amazon Kinesis',
    isImplemented: false
  },
  {
  ...
  {
    id: 'rabbitmq-to-amazon-mq',
    label: 'RabbitMQ to Amazon MQ',
    description: 'Migrate RabbitMQ to AWS Amazon MQ',
    isImplemented: false
  },
  {
    id: 'mq-to-service-bus',
    label: 'IBM MQ to Service Bus',
    description: 'Migrate IBM MQ to Azure Service Bus',
    isImplemented: false
  },
  {
    id: 'activemq-to-service-bus',
    label: 'ActiveMQ to Service Bus',
    description: 'Migrate Apache ActiveMQ to Azure Service Bus',
    isImplemented: false
  },
  {
    id: 'msmq-to-service-bus',
    label: 'MSMQ to Service Bus',
    description: 'Migrate Microsoft Message Queue to Azure Service Bus',
    isImplemented: false
  },
  {
    id: 'sqs-to-service-bus',
    label: 'AWS SQS to Service Bus',
    description: 'Migrate Amazon SQS to Azure Service Bus',
    isImplemented: false
  },
  {
    id: 'azure-queue-to-service-bus',
    label: 'Azure Queue to Service Bus',
    description: 'Migrate Azure Queue Storage to Azure Service Bus',
    isImplemented: false
  },
  {
    id: 'redis-pubsub-to-service-bus',
    label: 'Redis Pub/Sub to Service Bus',
    description: 'Migrate Redis Pub/Sub to Azure Service Bus',
    isImplemented: false
  },
  {
    id: 'google-pubsub-to-service-bus',
    label: 'Google Pub/Sub to Service Bus',
    description: 'Migrate Google Cloud Pub/Sub to Azure Service Bus',
    isImplemented: false
  },
  {
    id: 'pulsar-to-service-bus',
    label: 'Apache Pulsar to Service Bus',
    description: 'Migrate Apache Pulsar to Azure Service Bus',
    isImplemented: false
  },
  {
    id: 'nats-to-service-bus',
    label: 'NATS to Service Bus',
    description: 'Migrate NATS messaging to Azure Service Bus',
    isImplemented: false
  }
];
